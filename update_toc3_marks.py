...
PDF_PATH = r'c:\Users\parul\Desktop\marksheet\marksheet_SEM-IV\Compile_Marksheet_SEM_IV_CE_IT_2026_T3_TOC.pdf'
...
pdf_records = {}   # enrollment -> T3 TOC mark
...
print(f"Successfully parsed {len(pdf_records)} records from the T3 TOC PDF.")
...
for student in data:
    ...
    if enroll in pdf_records:
        ...
        student["toc3"] = t3_mark
        
        # Add T3 mark to cumulative TOC column
        existing_toc = student.get("toc", 0.0) or 0.0
        student["toc"] = round(float(existing_toc) + t3_mark, 1)
